...
def _get_neuron_input_table(N_all: Forest_graph, return_missing: bool = False, tol: int = 0):
...
def _get_neuron_output_table(N_all: Forest_graph, return_missing: bool = False, tol: int = 0):
...
def Neuron_synapse_table(N_all: Forest_graph, direction:str = 'all', return_missing:bool = False):
