...
def scale(coords:np.ndarray, s:float | np.ndarray, invert = True):
    """scale the given coordinates linearly along each axis. This will 
    ...
    invert: bool
        Whether or not to invert the scaling matrix. If true, coordinates are scaled by 1/s 
    Returns
    -------
    np.ndarray
