...
def align_neuron(N:Tree_graph, synapses:bool = True, scale:bool = True, s: int|float|np.ndarray|NoneType = None, invert:bool = True, bind:bool = True, unpack:bool = True, **kwargs) -> list | np.ndarray | nr.Tree_graph:
