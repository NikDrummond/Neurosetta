...
def vertex_hierarchical_clusters(N: Tree_graph | gt.Graph,subset: np.ndarray | None = None ,distance: str = 'Path Length',method: str = 'ward',k: int = 3) -> tuple(np.ndarray,np.ndarray):
    """_summary_
