...
def scale(coords:np.ndarray, s:float | np.ndarray):
    """Scales a given set of coordinates. if method is "equal_var" scales so variance = 1 in all directions,
    otherwise scales using s.

    THIS SHOULD REALY REALY ONLY BE USED WHEN THE LOCAL COORDINATES ARE ALIGNED TO 
