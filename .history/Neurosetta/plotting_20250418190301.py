...
def _vd_subtree_lns(N:Tree_graph, c1:str = 'g', c2:str = 'r', **kwargs) -> tuple[vd.Lines, vd.Lines]:
    ...
    if g_has_property(N, g_property='subtree_mask', t = 'v') & g_has_property(N, g_property='subtree_mask', t = 'e'):
        # get all coordinates
        coords = g_vert_coords(N)
        # filter in
