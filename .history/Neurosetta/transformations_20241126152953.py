...
def eig_axis_eulers(evects):
    ...
    """
    # Yaw
    theta1 = np.rad2deg(np.arctan2(evects[0][0] / evects[0][1]))
    # pitch
    theta2 = np.rad2deg(np.arctan2(evects[1][2] / evects[1][0]))
    # roll
    theta3 = np.rad2deg(np.arctan2(evects[2][1] / evects[2][2]))
