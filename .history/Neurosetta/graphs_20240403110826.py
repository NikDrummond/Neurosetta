...
def g_has_property(
    ...
    If the g_property argument is None (default), all graph, vertex, and edge properties are checked against. If however the looked for property is a specific type, then the g argument must be set to either "v", "e", or "g".
    """
