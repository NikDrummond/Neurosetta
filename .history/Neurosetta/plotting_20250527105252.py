...
def _vd_subtree_lns(
    N: nr.Tree_graph, c1: str = "g", c2: str = "r", **kwargs
    ...
    if nr.g_has_property(N, g_property="subtree_mask", t="v") & nr.g_has_property(
        N, g_property="subtree_mask", t="e"
    ):
        # if we do not have inverted masks, create them:
        if not nr.g_has_property(N, g_property="inv_subtree_mask", t="v") & nr.g_has_property(
        ...
        lns_in = vd.Lines(start_pts=start_pnts, end_pts=stop_pnts, c="g", lw = 3)
